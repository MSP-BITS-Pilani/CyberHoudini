...
class Quiz extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      hint: null,
      fadeIn: false,
      encryptArray: ["-1", "0", "82", "129", "235", "371", "649", "793", "1139", "1349", "1679", "2291", "2573", "13", "14", "99999999"]
    }
  }
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center">
              ...
              <h2>Congratulations. You are so lonely that you might just deserve a prize for that. See the leaderboard if you won or not.</h2>
              <Link to="/">
